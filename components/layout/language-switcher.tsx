      ...
      {locales.map(({ code, name, flag, fullName }) => {
        ...
        return (
          <button
            ...
            className={cn(
              "group relative flex items-center gap-1.5 overflow-hidden rounded-full px-2.5 py-1.5 text-[11px] font-semibold uppercase tracking-[0.18em] transition-all duration-300 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/60 hover:-translate-y-px sm:px-3 sm:text-xs",
              isActive
