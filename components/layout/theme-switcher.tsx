...
const ThemeSwitcher = () => {
  ...
  return (
    <div className="flex items-center gap-2">
          ...
          return (
            <button
              ...
              className={cn(
                ...
                isActive
                  ? "bg-primary text-primary-foreground shadow-[0_22px_40px_-25px_rgba(59,130,246,0.85)] ring-1 ring-primary/70 dark:shadow-[0_18px_36px_-22px_rgba(148,163,184,0.55)]"
            ...
            >
              ...
              <Icon
                ...
                className={cn(
                  ...
                  isActive
                    ? "text-primary-foreground drop-shadow-[0_6px_12px_rgba(15,23,42,0.35)]"
      ...
      <span className="hidden text-[11px] font-semibold uppercase tracking-[0.28em] text-muted-foreground/80 sm:inline">
