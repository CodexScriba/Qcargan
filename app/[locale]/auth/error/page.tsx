      ...
      <main className="mx-auto flex w-full max-w-[1600px] flex-1 items-center justify-center px-4 py-24 sm:px-6 lg:px-12">
        <section className="card-container w-full max-w-2xl">
          <div
            ...
            data-slot="card"
          >
            <div className="inline-flex h-16 w-16 items-center justify-center rounded-full bg-secondary/55 text-title-blue">
            ...
            <div className="space-y-3">
              <div
                ...
                aria-hidden="true"
              />
              <h1 className="text-balance text-3xl font-semibold tracking-tight text-title-blue sm:text-4xl">
                {t("title")}
              </h1>
